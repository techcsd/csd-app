...
## Estado de release (2026-07-18) — v1.16.0 (Actualización 1: login conductor, tipos, visibilidad, imágenes)
...
- **Release:** bump 1.15.0 → **1.16.0** (environments + build.gradle + release-apk). Publicada NO bloqueante; **mínima se mantiene en 1.15.0** (piso = fix del crash; no forcé 1.16.0 porque son features). `MIN_VERSION` del script sigue en 1.15.0 (alineado con la fila `minima`).
