...
**Pendiente (único — background, edge/deploy):** transcripción de audios de sub-ítem (voz de restricción/falla en columnas `audio_path`) — extender el cron `transcribe-audio`; + mostrar la transcripción de la voz general en el detalle de bitácora/incidente del app (mi-registro ya la muestra). Ver `PROMPT-10-ESTADO-CSD-APP.md`.
