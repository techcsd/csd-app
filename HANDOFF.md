...
**Pendiente (único — background, edge/deploy):** transcripción de audios de **sub-ítem** (voz de restricción/falla en columnas `audio_path`) — extender el edge `transcribe-audio` para barrerlas + redeploy (Deno). La captura/reproducción ya funcionan; todo lo demás de PROMPT-10 está hecho y publicado. Ver `PROMPT-10-ESTADO-CSD-APP.md`.
