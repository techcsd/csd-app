...
**Pendiente (device-QA / nativo / grande — tramo enfocado):** AA18.3 (mostrar horas vs km en los flujos de captura: echadas/pre-uso/mantenimiento/entrega/perfil), AA19 (reordenar fotos+portada), AA16 (bridge nativo de micrófono), transcripción de audios de sub-ítem (extender cron) + mostrarla en detalle de bitácora/incidente del app. Ver `PROMPT-10-ESTADO-CSD-APP.md`.
